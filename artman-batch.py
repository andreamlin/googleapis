# Run this script from api-client-staging/googleapis.
# Dumps only the gapics into api-client-staging/googleapis/artman-genfiles/staging/generated/java.
...
for api in artman_files:
  cmd = "rm -rf " + cwd + "/artman-genfiles/api-client-staging"
  print(cmd)
  ...
  check_call(cmd.split())
  i += 1
  cmd = "mv " + cwd + "/artman-genfiles/api-client-staging/generated/java/" + gapic +  " " + cwd + "/artman-genfiles/staging/generated/java/" + gapic
  print(cmd)
  check_call(cmd.split())
